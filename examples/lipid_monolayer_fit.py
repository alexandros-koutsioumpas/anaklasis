...
res = anaklasis.fit(project, in_file, units, fit_mode, fit_weight, method, resolution,
			 patches, system, param, multi_param, constraints,background,scale,
			 experror=True,plot=True,fast=True)

# Note that the tuple (res) contains the results in the form of four lists
# res[0] list containg reflectivity (Q, R(Q), R(Q)Q^4)
# res[1][0] list containing the sld profile (z, sld, sld standard deviation)
# res[2][0] list containing the solvent profile (z, solv, sld standard deviation)
# res[3] list containing the chi squared for each fitted input curve